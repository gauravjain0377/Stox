    ...
    <section className="hero-section" style={{ minHeight: '70vh', background: '#fafafa' }}>
      <div className="hero-content" data-aos="fade-up">
        ...
        <h1 className="hero-title">
          Building India's Most <br /> Transparent Trading Platform
        </h1>
        ...
        <div style={{ fontSize: '1.15rem', color: '#4a5568', fontWeight: 400, maxWidth: 650, margin: '0 auto 2.8rem auto', lineHeight: 1.7 }}>
          Started in 2023 with a simple belief: every Indian deserves access to fair, transparent, and affordable stock trading. What began as a personal project has evolved into a mission to empower millions of investors across India.
        </div>
